  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="clinica-esther-fernandez";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Clínica Esther Fernández"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="clinica-esther-fernandez"
          data-primary-color="#b79774"
          defer
        ></script>
      </head>
